...
<title>{{ shop_name }} - Параметры учётной записи для {{ user_name }}</title>
<style>
                ...
                <td class="titleblock" style="border-bottom: 1px solid #e2e7eb; padding: 7px 0" align="center">
                  <font size="2" face="Open-sans, sans-serif" color="#555454">
                    ...
                    <span class="subtitle" style="font-weight: 500; font-size: 16px; text-transform: uppercase; line-height: 25px">
                      Спасибо за регистрацию на {{ shop_name }}
                    </span>
                  </font>
                </td>
              </tr>
                        ...
                        <td style="padding: 7px 0">
                          <font size="2" face="Open-sans, sans-serif" color="#555454">
                            ...
                            <span style="color: #777; font-family: Open-sans,sans-serif; font-size: small">
                              Ваша учётная запись создана, но должна быть проверена прежде, чем вы сможете ею воспользоваться. Чтобы подтвердить вашу учётную запись, перейдите по ссылке, приведённой ниже, или вставьте её в адресную строку браузера:
                              <br><br>
                              <a style="color: #5e6981" href="{{ activate_url }}"><code>{{ activate_url }}</code></a>
                              <br><br>
                              После проверки, администратору сайта будет отправлено сообщение о необходимости активировать вашу учётную запись. После активации учётной записи вы сможете войти на сайт {{ shop_url }}, используя логин и пароль приведённые ниже:
                              <br><br>
                              Логин: <strong style="color: #333">{{ user_login }}</strong><br>
                              Пароль: <strong style="color: #333">{{ user_password }}</strong>
                            </span>
                          </font>
                        </td>
                        <td style="padding: 7px 0" width="10"></td>
                        ...
                        <td style="padding: 7px 0">
                          <font size="2" face="Open-sans, sans-serif" color="#555454">
                            ...
                            <ol style="margin-bottom: 0">
                              <li>Всегда храните свои данные в безопасности.</li>
                              <li>Никогда не передавайте никому свои данные для входа.</li>
                              <li>Регулярно меняйте пароль.</li>
                              <li>Если вы подозреваете, что кто-то использует вашу учетную запись незаконно, пожалуйста, немедленно сообщите нам.</li>
                            </ol>
                          </font>
                        </td>
                        <td width="10" style="padding:7px 0">&nbsp;</td>
