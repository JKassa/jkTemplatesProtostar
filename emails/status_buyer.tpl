...
<title>{{ shop_name }} - Ваш заказ изменен</title>
<style>
            ...
            <tbody>
              ...
              <tr>
                <td class="titleblock" style="border-bottom: 1px solid #e2e7eb; padding: 7px 0" align="center">
                  <span class="title" style="color: #555454; font-family: Open-sans,sans-serif; font-size: 28px; font-weight: 500; text-transform: uppercase; line-height: 33px">
                        ...
                        <td style="padding: 7px 0">
                          <font size="2" face="Open-sans, sans-serif" color="#555454">
                            <p data-html-only="1" style="border-bottom: 1px solid #D6D4D4; margin: 3px 0 7px; text-transform: uppercase; font-weight: 500; font-size: 18px; padding-bottom: 10px">
                              Заказ {{ pm_number }} - изменен
                            </p>
                            <span style="color:#777">
                              Ваш заказ с кодом <strong style="color: #333">{{ pm_number }}</strong> в магазине <strong style="color: #333">{{ shop_name }}</strong> изменён продавцом.<br>
                              Состояние заказа: <strong style="color: #333">{{ order_status }}</strong>.
                            </span>
                          </font>
                        </td>
                        <td style="padding: 7px 0" width="10"></td>
