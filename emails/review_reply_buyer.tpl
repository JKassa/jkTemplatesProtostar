            ...
            <tbody>
              ...
              <tr>
                <td class="linkbelow" style="padding: 7px 0">
                  <font size="2" face="Open-sans, sans-serif" color="#555454">
					В магазине "{{ shop_name }}" был добавлен новый ответ на отзыв для продукта <a href="{{ product_url }}">{{ product_name }}</a>.
                  </font><br><br>
				  <font size="2" face="Open-sans, sans-serif" color="#555454">
              ...
              <tr>
                <td class="linkbelow" style="border-top: 1px solid #e2e7eb; padding: 7px 0">
                  <font size="2" face="Open-sans, sans-serif" color="#555454">
					<em>* Это письмо отправлено вам, так как вы были подписаны на уведомления о новых отзывах для продукта "{{ product_name }}". Чтобы отказаться от подписки <a href="{{ url_unsubscribe }}">нажмите здесь</a>.</em><br>
