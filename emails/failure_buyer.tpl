                        ...
                        <td style="padding: 7px 0">
                          <font size="2" face="Open-sans, sans-serif" color="#555454">
                            ...
                            <span style="color: #777; font-family: Open-sans,sans-serif; font-size: small">
                              Возникла проблема с оплатой заказа с кодом {{ pm_number }} в магазине {{ shop_name }}. Пожалуйста, свяжитесь с нами как можно скорее.
                              <br><br>
                              <strong style="color: #333;">Мы не можем отправить заказ до получения платежа!</strong>
                            </span>
                          </font>
                        </td>
                        <td style="padding: 7px 0" width="10"></td>
