                        ...
                        <td style="padding: 7px 0">
                          <font size="2" face="Open-sans, sans-serif" color="#555454">
                            ...
                            <span style="color: #777; font-family: Open-sans,sans-serif; font-size: small">
                              Ваша учётная запись создана, но должна быть активирована прежде, чем вы сможете ею воспользоваться. Чтобы активировать учётную запись, перейдите по ссылке ниже, или скопируйте её в адресную строку браузера:
                              <br><br>
                              <a style="color: #5e6981" href="{{ activate_url }}"><code>{{ activate_url }}</code></a>
                              <br><br>
                              После активации вы сможете входить на <a style="color: #5e6981" href="{{ shop_url }}">сайт</a> с помощью указанных ниже логина и пароля.
                              <br><br>
